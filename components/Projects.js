...
const projects = [
    {
        ...
        image: "/projects/video_transcription.png"
    },
    {
    ...
    },
    {
        ...
        image: "/projects/accessibility_analyzer.png"
    }
]
                ...
                {projects.map((project, idx) => (
                    ...
                    >
                        ...
                        <div className={styles.projectInfo}>
                            <div className={styles.category}><Layers size={14} /> AI Project</div>
                            <h3>{project.title}</h3>
                            <p>{project.desc}</p>
